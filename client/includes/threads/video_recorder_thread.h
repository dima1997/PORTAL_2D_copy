#ifndef VIDEO_RECORDER_THREAD_H
#define VIDEO_RECORDER_THREAD_H
...
class VideoRecorderThread : public Thread {
private:
    bool isDead;
    OutputFormat outputFormat;
    BlockingQueue<std::unique_ptr<std::vector<char>>> & videoFramesQueue;
    std::mutex mutex;
